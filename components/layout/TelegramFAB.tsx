export function TelegramFAB() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-full text-sm font-medium shadow-lg hover:opacity-90 hover:-translate-y-px transition-all"
